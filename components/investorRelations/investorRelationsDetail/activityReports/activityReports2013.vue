<template>
    <div>
      <div class="pdf-content-detail">
        ...
        <div class="pdf-content-detail" v-if="isCollapsed">
          <button class="pdf-button" @click="pdf2013()">
          <img
            ...
            height="24"
          />
          Faaliyet Raporu(31.12.2013) - 2013-12-31
        </button>
        </div>
      </div>
  ...
  export default {
    ...
    methods: {
      ...
      pdf2013() {
        const pdfUrl = "https://cdn.napolyon.com/skyalp/images/faaliyet-raporu-2013.pdf";
        const link = document.createElement("a");
        link.href = pdfUrl;
        link.target = "_blank";
        link.download = "faaliyet-raporu-2013.pdf"; 
        link.click();
      },
    },
  };
