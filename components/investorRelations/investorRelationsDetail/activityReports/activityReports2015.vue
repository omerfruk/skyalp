  ...
  <div>
    <div class="pdf-content-detail">
      ...
      <div class="pdf-content-detail" v-if="isCollapsed">
        <button class="pdf-button" @click="pdf2015()">
          <img
            ...
            height="24"
          />
          Faaliyet Raporu(31.12.2015) - 2015-12-31
        </button>
      </div>
    </div>
  </div>
...
export default {
  ...
  methods: {
    ...
    pdf2015() {
        const pdfUrl = "https://cdn.napolyon.com/skyalp/images/faaliyet-raporu-31.12.2015.pdf";
        const link = document.createElement("a");
        link.href = pdfUrl;
        link.target = "_blank";
        link.download = "faaliyet-raporu(31.12.2015) - 2015-12-31.pdf";
        link.click();
      },
  },
};
