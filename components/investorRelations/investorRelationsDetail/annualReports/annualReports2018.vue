<template>
  ...
  export default {
    ...
    methods: {
      ...
      pdfOne() {
        const pdfUrl =
          "https://cdn.napolyon.com/skyalp/images/toplanti-tutanagi-2018.pdf";
  
        const link = document.createElement("a");
        link.href = pdfUrl;
        link.target = "_blank";
        link.download = "toplanti-tutanagi-2018.pdf";
        link.click();
      },
      pdfThree() {
        const pdfUrl =
          "https://cdn.napolyon.com/skyalp/images/bilgilendirme-dokumani-2018.pdf";
        const link = document.createElement("a");
        link.href = pdfUrl;
        link.target = "_blank";
        link.download = "bilgilendirme-dokumani-2018.pdf";
        link.click();
      },
      pdfFour() {
        const pdfUrl =
          "https://cdn.napolyon.com/skyalp/images/gundem-2018.pdf";
        const link = document.createElement("a");
        link.href = pdfUrl;
        link.target = "_blank";
      ...
      pdfFive() {
        const pdfUrl =
          "https://cdn.napolyon.com/skyalp/images/hazir-bulunanlar-listesi-2018.pdf";
        const link = document.createElement("a");
        link.href = pdfUrl;
        link.target = "_blank";
      ...
      pdfSix() {
        const pdfUrl =
          "https://cdn.napolyon.com/skyalp/images/davet-duyurusu-2018.pdf";
        const link = document.createElement("a");
        link.href = pdfUrl;
        link.target = "_blank";
        link.download = "davet-duyurusu-2018.pdf";
        link.click();
      },
    },
  };
