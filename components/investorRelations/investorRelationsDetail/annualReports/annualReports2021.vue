<template>
        ...
        <div class="pdf-content-detail" v-if="isCollapsed">
          <button class="pdf-button" @click="pdfOne()">
            <img
              ...
              height="24"
            />
            2021 Olağan Genel Kurul Toplantı Tutanağı
          </button>
  ...
  export default {
    ...
    methods: {
      ...
      pdfOne() {
        const pdfUrl =
          "https://cdn.napolyon.com/skyalp/images/toplanti-tutanagi-2021.pdf";
  
        const link = document.createElement("a");
        link.href = pdfUrl;
        link.target = "_blank";
        link.download = "toplanti-tutanagi-2021.pdf";
        link.click();
      },
      pdfThree() {
        const pdfUrl =
          "https://cdn.napolyon.com/skyalp/images/bilgilendirme-dokumani-2021.pdf";
        const link = document.createElement("a");
        link.href = pdfUrl;
        link.target = "_blank";
        link.download = "bilgilendirme-dokumani-2021.pdf";
        link.click();
      },
      pdfFour() {
        const pdfUrl =
          "https://cdn.napolyon.com/skyalp/images/gundem-2021.pdf";
        const link = document.createElement("a");
        link.href = pdfUrl;
        link.target = "_blank";
      ...
      pdfFive() {
        const pdfUrl =
          "https://cdn.napolyon.com/skyalp/images/hazir-bulunanlar-listesi-2021.pdf";
        const link = document.createElement("a");
        link.href = pdfUrl;
        link.target = "_blank";
      ...
      pdfSix() {
        const pdfUrl =
          "https://cdn.napolyon.com/skyalp/images/davet-duyurusu-2021.pdf";
        const link = document.createElement("a");
        link.href = pdfUrl;
        link.target = "_blank";
        link.download = "davet-duyurusu-2021.pdf";
        link.click();
      },
    },
  };
