<template>
        ...
        <div class="pdf-content-detail" v-if="isCollapsed">
          <button class="pdf-button" @click="pdfOne()">
            <img
              ...
              height="24"
            />
            2022 Olağan Genel Kurul Toplantı Tutanağı
          </button>
  ...
  export default {
    ...
    methods: {
      ...
      pdfOne() {
        const pdfUrl =
          "https://cdn.napolyon.com/skyalp/images/toplanti-tutanagi-2022.pdf";
  
        const link = document.createElement("a");
        link.href = pdfUrl;
        link.target = "_blank";
        link.download = "toplanti-tutanagi-2022.pdf";
        link.click();
      },
      pdfThree() {
        const pdfUrl =
          "https://cdn.napolyon.com/skyalp/images/bilgilendirme-dokumani-2022.pdf";
        const link = document.createElement("a");
        link.href = pdfUrl;
        link.target = "_blank";
        link.download = "bilgilendirme-dokumani-2022.pdf";
        link.click();
      },
      pdfFour() {
        const pdfUrl =
          "https://cdn.napolyon.com/skyalp/images/gundem-2022.pdf";
        const link = document.createElement("a");
        link.href = pdfUrl;
        link.target = "_blank";
      ...
      pdfFive() {
        const pdfUrl =
          "https://cdn.napolyon.com/skyalp/images/hazir-bulunanlar-listesi-2022.pdf";
        const link = document.createElement("a");
        link.href = pdfUrl;
        link.target = "_blank";
      ...
      pdfSix() {
        const pdfUrl =
          "https://cdn.napolyon.com/skyalp/images/davet-duyurusu-2022.pdf";
        const link = document.createElement("a");
        link.href = pdfUrl;
        link.target = "_blank";
        link.download = "davet-duyurusu-2022.pdf";
        link.click();
      },
      pdfSeven() {
        const pdfUrl =
          "https://cdn.napolyon.com/skyalp/images/hukuki-beyan-2022.pdf";
        const link = document.createElement("a");
        link.href = pdfUrl;
        link.target = "_blank";
        link.download = "hukuki-beyan-2022.pdf";
        link.click();
      }
    },
  };
