<template>
  ...
  export default {
    ...
    methods: {
      ...
      pdfOne() {
        const pdfUrl =
          "https://cdn.napolyon.com/skyalp/images/toplanti-tutanagi-2015.pdf";
  
        const link = document.createElement("a");
        link.href = pdfUrl;
        link.target = "_blank";
        link.download = "toplanti-tutanagi-2015.pdf";
        link.click();
      },
      pdfTwo() {
        const pdfUrl =
          "https://cdn.napolyon.com/skyalp/images/2015-yili-kar-dagitim-tablosu.pdf";
        const link = document.createElement("a");
        link.href = pdfUrl;
        link.target = "_blank";
        link.download = "2015-yili-kar-dagitim-tablosu.pdf";
        link.click();
      },
      pdfThree() {
        const pdfUrl =
          "https://cdn.napolyon.com/skyalp/images/2015-yili-kar-dagitim-teklifi.pdf";
        const link = document.createElement("a");
        link.href = pdfUrl;
        link.target = "_blank";
        link.download = "2015-yili-kar-dagitim-teklifi.pdf";
        link.click();
      },
      pdfFour() {
        const pdfUrl =
          "https://cdn.napolyon.com/skyalp/images/gundem-2015.pdf";
        const link = document.createElement("a");
        link.href = pdfUrl;
        link.target = "_blank";
      ...
      pdfFive() {
        const pdfUrl =
          "https://cdn.napolyon.com/skyalp/images/hazir-bulunanlar-listesi-2015.pdf";
        const link = document.createElement("a");
        link.href = pdfUrl;
        link.target = "_blank";
      ...
      pdfSix() {
        const pdfUrl =
          "https://cdn.napolyon.com/skyalp/images/ilan-metni-2015.pdf";
        const link = document.createElement("a");
        link.href = pdfUrl;
        link.target = "_blank";
        link.download = "ilan-metni-2015.pdf";
        link.click();
      },
      pdfSeven() {
        const pdfUrl =
          "https://cdn.napolyon.com/skyalp/images/vekaletname-2015.pdf";
        const link = document.createElement("a");
        link.href = pdfUrl;
        link.target = "_blank";
        link.download = "vekaletname-2015.pdf";
        link.click();
      }
